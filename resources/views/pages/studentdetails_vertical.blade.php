...
<section class="student_portfolio_tabs">
    <div class="container">
        <div class="row">
                ...
                <div id="tabs-10" class="tabs tabs-vertical border">
                    ...
                    <ul class="tabs-navigation">
                        <li class="active"><a href="#About003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Basic Details</span></a> </li>
                        <li><a href="#Services003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Education</span></a> </li>
                        <li><a href="#Choose003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Certification</span></a> </li>
                        <li><a href="#Assets003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Experience</span></a> </li>
                        <li><a href="#Assets003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Skills</span></a> </li>
                        <li><a href="#Assets003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Additional Info</span></a> </li>
                        
                        <li><a href="#Assets003"><i class="fa fa-home"></i><span class="hidden-sm hidden-xs">Resume</span></a> </li>
                    </ul>
