...
<!-- PAGE TITLE -->
<section id="page-title" class="page-title-parallax text-light background-overlay-dark" style="background: url('images/parallax/15.jpg')" data-stellar-background-ratio="0.5">
    <div class="container">
...
<div class="page_toggle">
        <h2>Toggle fancy radius (clean)</h2>
