                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group required">
                                    ...
                                    <select name='company' name='company_type' class="form-control">
                                        <option>Type A</option>
                                        <option>Type B</option>
                                        <option>Type C</option>
                                        <option>Type D</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group required">
                                    ...
                                    <input required type="numtextber" class="form-control" name='Address_line1' id="InputName"
                                           placeholder="Address Line 1">
                                </div>
                                <div class="form-group required">
                                    <label for="InputName">Address Line 2 </label>
                                    <input required type="numtextber" class="form-control" name='Address_line2' id="InputName"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6" id="links_url_employer">
                            <div class="form-group required">
                                ...
                                <input required type="text" class="form-control" name='uri' id="InputName"
