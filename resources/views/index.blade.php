...
<div class="modal-content">
  ...
  <div class="modal-footer">
                    <div>
                        <button name="submit" class="btn-block button button-dark rounded"  type="button" onclick=""> <i class="glyphicon glyphicon-off" ></i> LOGIN</button>
                    </div>
  </div>
</div>
</div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
               <div class="form-group login-username">
                    <div >
                       <input name="fn_signup_employer" id="fn_signup_employer" class="form-control input" size="20"
                ...
                <div class="form-group">
                    <div >
                        ...
                        <input name="ln_signup_employer" id="ln_signup_employer" class="form-control input" size="20"
                ...
                <div class="form-group">
                    <div >
                        ...
                        <input name="email_signup_employer" id="email_signup_employer" class="form-control input" size="20"
                               placeholder="Enter Your Email" type="email" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div >
                        ...
                        <input name="pass_signup_employer" id="pass_signup_employer" class="form-control input" size="20"
                               placeholder="Password" type="password" required>
                    </div>
                </div> 
                <div class="form-group">
                    <div >
                        ...
                        <input name="cpass_signup_employer" id="cpass_signup_employer" class="form-control input" size="20"
  ...
  <div class="modal-footer">
                    <div>
                        <button name="submit" class="btn-block button button-dark rounded"  type="button" onclick="signup_employee();"> <i class="glyphicon glyphicon-off" ></i> SignUp</button>
                    </div>
  </div>
</div>
</div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
                ...
                <div class="form-group login-username">
                    <div >
                        ...
                        <input name="fn_signup" id="fn_signup" class="form-control input" size="20"
                ...
                <div class="form-group">
                    <div >
                        ...
                        <input name="ln_signup" id="ln_signup" class="form-control input" size="20"
                               placeholder="Enter Your Last name" type="text" required>
                    </div>
                </div>
                <div class="form-group">
                    <div >
                        ...
                        <input name="email_signup" id="email_signup" class="form-control input" size="20"
                               placeholder="Enter Your Email" type="email" required>
                    </div>
                </div>
                <div class="form-group">
                    <div >
                        ...
                        <input name="pass_signup" id="pass_signup" class="form-control input" size="20"
                               placeholder="Password" type="password" required>
                    </div>
                </div> 
                <div class="form-group">
                    <div >
                                            <input name="cpass_signup" id="cpass_signup" class="form-control input" size="20"
                               placeholder="Confirm Your Password" type="password" required>
                    </div>
                </div>
                <div class="input-group">
  ...
  <div class="modal-footer">
                    <div>
                        ...
                        <button name="submit" class="btn-block button button-dark rounded"  type="button" onclick='signup();'> <i class="glyphicon glyphicon-off" ></i> SignUp</button>
                    </div>
  </div>
</div>
</div>
...
<script>
	...
	function signup() {
        var name=document.getElementById('fn_signup').value;
		var last_name=document.getElementById('ln_signup').value;
        var email=document.getElementById('email_signup').value;
        var password=document.getElementById('pass_signup').value;
		$.ajax({
			url: './employee',
			data: $.param({first_name: name,last_name:last_name,email:email,password:password}),
			method: 'POST'
...
function signup_employee(){

	var firstname_employee=document.getElementById('fn_signup_employer').value;
	var lastname_employee=document.getElementById('ln_signup_employer').value;
	var email_employee=document.getElementById('email_signup_employer').value;
	var companyname=document.getElementById('companyname').value;
	var mobile=document.getElementById('mobile').value;
	var password_employee=document.getElementById('pass_signup_employer').value;
	var confirm_password=document.getElementById('cpass_signup_employer').value;
$.ajax({
	url:'./employee',
	data:$.param({first_name:firstname_employee,last_name:lastname_employee,email:email_employee,company_name:companyname,mobile:mobile,password:password_employee}),
	method:'POST'
}).then(function(response){
	console.log(response);
	alert(response);
...
function login(){
    var email_login_student=document.getElementById('login-user-student').value;
	var login_password_student=document.getElementById('login-password-student').value;
$.ajax({
	url:'./login_student',
	data:$.param({email_login_student:email_login_student,login_password_student:login_password_student}),
	method:'POST'
}).then(function(response){
	console.log(response);
	alert(response);
